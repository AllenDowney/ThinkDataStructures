...
it's linear. I'll explain how to handle this in Section~\ref{classifying-add}.
...
Chapter~\ref{???}, you already have a program that reads a Wikipedia
...
information about your Redis server.  See Section~\ref{???} for details.
...
\section{\java{Comparable} and \java{Comparator}}

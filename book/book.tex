...
In the directory named {\tt code}, you should find these files and directories:
...
In the subdirectory \java{javacs-lab02/src/com/allendowney/javacs}
...
In the subdirectory \java{javacs-lab03/src/com/allendowney/javacs}
you'll find the source files you need for this exercise:
...
In the subdirectory \java{javacs-lab04/src/com/allendowney/javacs}
you'll find the source files you need for this exercise:

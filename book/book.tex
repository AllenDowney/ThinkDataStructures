...
\url{https://www.ibm.com/developerworks/java/library/j-jtp01255/index.html}.
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/Collection.html#add(E)}.
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#set(int E)}, then fill in the body of this method. If you run
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#indexOf(java.lang.Object)}
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#add(int E)},
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#remove(int)}. When
you finish this one, all tests should pass.

Once you have your implementation working, compare it to mine, which you
can read at
\url{https://github.com/AllenDowney/ThinkDataStructures/blob/master/solutions/src/com/allendowney/thinkdast/MyArrayList.java}.
...
Again, read the documentation at
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#add(int E)}, write an implementation, and run the tests for
confirmation.

Last one: fill in the body of \java{remove}.  The documentation is
here:
\url{https://docs.oracle.com/javase/8/docs/api/java/util/List.html\#remove(int)}.
...
\url{https://support.janova.us/entries/20181293-How-to-inspect-an-Element-in-Internet-Explorer}.
...
about at 
\url{https://jsoup.org/apidocs/org/jsoup/nodes/Element.html},
\url{https://jsoup.org/apidocs/org/jsoup/select/Elements.html}, and
\url{https://jsoup.org/apidocs/org/jsoup/nodes/Node.html}.
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/Deque.html},
...
\item
  ...
  you can read more about them at \url{https://www.tutorialspoint.com/java/java_regular_expressions.htm}.
...
\java{Map.put} at
  \url{https://docs.oracle.com/javase/8/docs/api/java/util/Map.html\#put(K, V)}
...
Read the documentation of \java{Map.get} at
  \url{https://docs.oracle.com/javase/8/docs/api/java/util/Map.html\#get(java.lang.Object)}
  and then fill in the method. Run the tests again.

Finally, read the documentation of \java{Map.remove} at
  \url{https://docs.oracle.com/javase/8/docs/api/java/util/Map.html\#remove(java.lang.Object)}
...
Language
(see \url{https://en.wikipedia.org/wiki/Unified_Modeling_Language}).
...
\url{https://docs.oracle.com/javase/tutorial/extra/generics/morefun.html}.
...
\url{https://docs.oracle.com/javase/8/docs/api/java/util/TreeMap.html\#keySet()},
...
about it at
\url{https://docs.oracle.com/javase/8/docs/api/java/util/LinkedHashSet.html}.
...
Hashes at \url{https://redis.io/topics/data-types}
...
context as stop words (\url{https://en.wikipedia.org/wiki/Stop_words}).
...
\item Read about TF-IDF at \url{https://en.wikipedia.org/wiki/Tf-idf}
...
\url{https://en.wikipedia.org/wiki/Insertion_sort}, which includes
...
read about it on
Wikipedia at \url{https://en.wikipedia.org/wiki/Merge_sort}.
...
\url{https://en.wikipedia.org/wiki/Recursion\#base_case}. If you are
...
\item If a dataset doesn't fit into the memory of one program, the runtime
  ...
  CPU caches and run
  faster (see \url{https://en.wikipedia.org/wiki/CPU_cache}.
